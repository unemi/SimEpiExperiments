...
gfN1=`echo $dirName | awk -F_ '{print '$gf3'+$4*.1}'`
gfPG=`echo $dirName | awk -F_ '{print '$gfN1'+$3*.05}'`
gfN3=`echo $dirName | awk -F_ '{print '$gfN1'+$2*.1}'`
gfX=5
#tl=349 # November 30
tl=380 # December 31
#
...
# Shifting from restricter measures to emergency declaration in July 5
  "days %3E%3D 201",["gatheringFrequency",$gfED,$gfEDd],
