...
x/'$pop',y/'$pop',z/16,sqrt(x2-x*x)/'$pop',sqrt(y2-y*y)/'$pop',sqrt(z2-z*z)/16}' X >> $pdir/peak
rm X
popd > /dev/null
end
...
set yrange [0:*]
set y2range [0:200]
plot 'peak' using (\$1-.03):2:5 title "peak", '' using 1:3:6 title "total in 200th day",\
 '' using (\$1+.03):4:7 title "peak day" axis x1y2
EOF
