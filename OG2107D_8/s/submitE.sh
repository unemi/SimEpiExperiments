...
# Shifting from restricter measures to emergency declaration in July 12
...
# Relaxing
  "days %3E%3D 229",["gatheringFrequency",$gfEDr,$gfEDrd],
# Lifting in August 9
  "days %3E%3D 236",["gatheringFrequency",$gfN1],  
