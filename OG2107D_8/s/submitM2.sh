...
gfEL=`echo $bias | awk -F_ '{print '$gf4'+$1*.2}'`  # Election
gfM2=`echo $bias | awk -F_ '{print '$gf4'+$1*.1}'`  # after election
gfOG=`echo $bias | awk -F_ '{print '$gfM2'+$1*.2}'` # Olympic games
gfN0=`echo $bias | awk -F_ '{print '$gfOG'+$1*.2}'`
...
# Vaccination priority change and speed up from July 12 to 19
  "days %3E%3D 208",["vaccinePriority",1],["vaccinePerformRate",$pr,7],
...
# Lifting restricter measures in July 26
  "days %3E%3D 222",["gatheringFrequency",$gfN0],
