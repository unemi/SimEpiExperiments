...
cmd=$rd
cms=`expr $cmd \* 16`
cmfi=../../D${rds}_167/inToLD.csv
cmft=../../D${rds}_167/tpToLD.csv
dmax=0
dmaxd=""
...
#
if [ "$1" == "" ]; then
dst="/Users/unemi/Program/SimEpidemic/Documents/Figures/VPD_$popN/$ds/$prs"
