...
elif [ $x -le 35 ]; then m="simepiM0$(((x-4)/4))"; n=$(((x-4)%4+1))
elif [ $x -le 40 ]; then m="simepi"; n=$((x-35))
elif [ $x -le 43 ]; then m="simepi2"; n=$((x-40))
elif [ $x -le 75 ]; then m="simepiM0$(((x-44)/4))"; n=$(((x-44)%4+1))
else m="simepi"; n=$((x-70))
fi
